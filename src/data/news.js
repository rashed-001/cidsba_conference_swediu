export const newsArticles = [
  ...
  {
    id: 4,
    title: "Workshop on Machine Learning Added to Program",
    excerpt: "A new hands-on workshop on machine learning techniques will be conducted during the conference. Limited seats available!",
    date: "2024-02-01",
    slug: "ml-workshop-added",
    content: "Full article content here..."
  },
  {
    id: 5,
    title: "Submission Deadline Extended",
    excerpt: "Due to popular demand, we have extended the paper submission deadline by two weeks. Don't miss this opportunity!",
    date: "2024-02-05",
  ...
  {
    id: 6,
    title: "Conference Venue Information Released",
    excerpt: "Detailed information about the conference venue, accommodation options, and travel guidelines are now available.",
    date: "2024-02-10",
    slug: "venue-information-released",
    content: "Full article content here..."
  }
];